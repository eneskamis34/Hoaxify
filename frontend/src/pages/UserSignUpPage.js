        ...
        return (
          <div className="container">
            <form>
              ...
              <img src="https://www.countryflags.io/tr/flat/24.png" alt="tr flag" onClick={()=>this.onChangeLanguage('tr')} style={{cursor:'pointer'}}/>
              <img src="https://www.countryflags.io/us/flat/24.png" alt="tr flag" onClick={()=>this.onChangeLanguage('en')} style={{cursor:'pointer'}}/>
            </form>
          </div>
        );
      }
